import { INotFavoriteBooksIcon } from "../../../types/favoriteBooksIcon/favoriteBooksIcon";
import { addBook } from "../../../pages/FavoriteBooks/favoriteBook";

export const NotFavoriteBookIcon = ({
  setFavorite,
  bookId,
  favoriteBooks,
  favoriteBook,
}: INotFavoriteBooksIcon) => {
  return (
    <svg
      onClick={() => addBook(favoriteBook, bookId, favoriteBooks)}
      className="bookDetails__favorite"
      width="56"
      height="56"
      viewBox="0 0 56 56"
      fill="#none"
