import { IFavoriteBooksIcon } from "../../../types/favoriteBooksIcon/favoriteBooksIcon";
import { deleteFromFavorite } from "../../../pages/FavoriteBooks/favoriteBook";

export const FavoriteBookIcon = ({
  setFavorite,
  bookId,
}: IFavoriteBooksIcon) => {
  return (
    <svg
      onClick={() => deleteFromFavorite(bookId)}
    ...
    >
      ...
      <path
        onClick={() => setFavorite("notFavorite")}
